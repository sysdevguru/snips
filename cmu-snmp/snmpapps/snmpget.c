 ...
 * SOFTWARE.
 * 
 * $Id: snmpget.c,v 1.16 1998/09/19 22:28:41 ryan Exp $
 * 
 **********************************************************************/
...
void Version(void)
{
  fprintf(stderr, "snmpget, version %s\n", snmpapps_Version());
...
void Usage(void)
{
  fprintf(stderr, "usage: snmpget [args] hostname community oid [oid]\n");
  fprintf(stderr, "\n");
  fprintf(stderr, "Args are:\n");
  fprintf(stderr, "  -d     Dump packets being sent / received\n");
  fprintf(stderr, "  -V     Print version information\n");
  fprintf(stderr, "  -v     Verbose output\n");
  fprintf(stderr, "  -q     Quiet mode: just print the value\n");
